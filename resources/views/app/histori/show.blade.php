<x-app-layout>
    <div class="card">
            ...
            @if ($data->gambar_awal)
                <div class="row">
                    <div class="col-4">
                        ...
                        <hr>
                        <h4 class="mt-3 fw-bold">{{ $data->proses1 }}</h4>
                        <p> {!! $data->keterangan1 !!}</p>
                    </div>
                    <div class="col-4">
                        <p>Gambar Tengah</p>
                        <img src="{{ Storage::url($data->gambar_tengah) }}" alt="Gambar tengah" width="100%"
                            height="400px" style="object-fit: cover">
                        <hr>
                        <h4 class="mt-3 fw-bold">{{ $data->proses2 }}</h4>
                        <p> {!! $data->keterangan2 !!}</p>
                    </div>
                    <div class="col-4">
                        <p>Gambar Akhir</p>
                        <img src="{{ Storage::url($data->gambar_akhir) }}" alt="Gambar akhir" width="100%"
                            height="400px" style="object-fit: cover">
                        <hr>
                        <h4 class="mt-3 fw-bold">{{ $data->proses3 }}</h4>
                        <p> {!! $data->keterangan3 !!}</p>
                    </div>
                </div>
            @endif
        ...
        <div class="card-footer bg-whitesmoke">
            <a href="{{ route('histori.index') }}" class="btn btn-danger">Kembali</a>
        </div>
    </div>
